		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
  			...
  			<div class="collapse navbar-collapse bg-info" id="navbarSupportedContent">
    			<ul class="navbar-nav mr-auto text-center ">
      				...
      				<li class="nav-item ">
        				<a class="nav-link text-center text-white" href="/ProyectoMultimedia/views/contacto.php">	Contacto	</a>
      				</li>
      				<li class="nav-item">
        				<a class="nav-link text-center text-white" href="#">	Nosotros	</a>
      				</li>
              <li class="nav-item">
                <a class="nav-link text-center text-white" href="/ProyectoMultimedia/views/registro.php">  Registrarse </a>
              </li>
    			</ul>
